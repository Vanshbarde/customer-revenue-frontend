//#region node_modules/.nitro/vite/services/ssr/assets/platform-D1qRX5YW.js
var KPI = {
	revenue: 2058e4,
	revenueDelta: -76.68,
	customers: 41599,
...
var PRODUCTS = [
	...
	{
		name: "Comfort-Flex Mattress Protector",
...
var REPORTS = [
	{
		...
		blurb: "Board-level snapshot of revenue, customers, and risk.",
		group: "core"
	},
	{
		id: "revenue",
		...
		blurb: "Growth, mix, and the late-period decline.",
		group: "core"
	},
	{
		id: "customers",
		...
		blurb: "Segments, value, and churn exposure.",
		group: "core"
	},
	{
		id: "products",
		...
		blurb: "Category leaders and long-tail contribution.",
		group: "core"
	},
	{
		id: "geography",
		...
		blurb: "State and city concentration of demand.",
		group: "core"
	},
	{
		id: "performance",
		...
		blurb: "Sellers, delivery, and operational quality.",
		group: "intel"
	},
	{
		id: "opportunity",
		...
		blurb: "Where the next rupee of revenue is hiding.",
		group: "intel"
	},
	{
		id: "predictions",
		name: "Predictions",
		title: "ML Insights",
		blurb: "Churn, CLV, and purchase propensity models.",
		group: "intel"
	}
];
var INSIGHTS = {
	overview: [
		{
			...
			metric: "-76.68%",
			tone: "danger",
			detail: "Latest revenue growth is -76.68%. September 2018 closed at ₹0.25M versus ₹1.05M in August. The available data confirms the decline, but does not establish the exact cause — the last month of the Olist extract is also incomplete.",
			next: [
				"Customer activity",
				"Transaction volume",
				"Product performance",
		...
		},
		{
			...
			metric: "₹5.99M",
			tone: "good",
			detail: "São Paulo accounts for ₹5.99M — roughly 29% of recorded revenue — and 15,540 customers. Concentration is a strength and a risk: a SP-only shock would move the whole P&L.",
			next: [
				"Secondary-state campaigns in RJ and MG",
				"Freight cost by state",
				"Seller coverage outside SP"
			]
		},
		{
			id: "ov-opp",
			...
			metric: "8,314",
			tone: "info",
			detail: "The opportunity model flags 8,314 customers with high propensity and residual value. Prioritising this cohort is the fastest path to recovering late-period revenue.",
			next: [
				"Personalised Health & Beauty offers",
				"Retention for overlapping at-risk VIPs",
				"Cross-sell housewares"
			]
		},
		{
			id: "ov-nov",
			...
			metric: "₹4.82M",
			tone: "good",
			detail: "November 2017 is the high-water mark at ₹4.82M and 22,100 orders. Seasonal playbooks from that month remain the best template for recovery campaigns.",
			next: [
				"Rebuild the November offer calendar",
				"Inventory for Health & Beauty and Watches",
				"Seller SLA ahead of peak"
			]
		}
	],
	revenue: [
		{
			...
			metric: "-76.68%",
			tone: "danger",
			detail: "Latest revenue growth is -76.68%. The available data confirms the decline, but does not establish the exact cause. September 2018 looks structurally thin versus the 2017 run-rate.",
			next: [
				"Customer activity",
				"Transaction volume",
				"Product-level sales"
		...
		},
		{
			...
			next: [
				"Share of wallet in SP",
				"Expansion into RJ / MG",
				"Payment method mix in SP"
			]
		},
		{
			id: "rev-cat",
			...
			metric: "₹1.44M",
			tone: "info",
			detail: "Health_Beauty is the leading named category at ₹1.44M. The long tail ('Others') still holds 60% of revenue, so category strategy cannot stop at the head.",
			next: [
				"Attach rate of beauty kits",
				"Margin by category",
				"Long-tail SKU rationalisation"
			]
		},
		{
			id: "rev-month",
	...
	customers: [
		{
			...
			metric: "12,230",
			tone: "info",
			detail: "Potential Loyalists are the largest cohort at 12,230 (29.4%). Converting a slice of this group into Loyal is higher leverage than acquiring net-new.",
		...
		},
		{
			...
			metric: "8,314",
			tone: "good",
			detail: "8,314 customers score high on residual value and propensity. Prioritise them for targeted offers before spraying the full base.",
		...
		},
		{
			...
			metric: "8,150",
			tone: "warn",
			detail: "8,150 customers are classified at risk, carrying ₹1.85M of historical revenue. Recency gaps and falling order frequency are the dominant drivers.",
			next: [
				"Win-back cadence",
				"VIP-at-risk white-glove",
	...
	products: [
		...
		},
		{
			...
			metric: "60.3%",
			tone: "warn",
			detail: "Named head categories explain under 40% of revenue. Assortment intelligence needs a long-tail view, not just top-10 charts.",
			next: [
				"SKU productivity",
				"Delist rules",
	...
	predictions: [
		...
		},
		{
			...
			tone: "info",
			detail: "When historical data is appended, CRIOI runs ETL → clean → database update → inference. Training is reserved for new datasets or drift.",
			next: ["Drift monitor", "Retrain policy"]
		}
	]
};
var AI_SYSTEM_CONTEXT = `You are CRIOI, the Customer Revenue Opportunity Intelligence assistant for ABC Retail Pvt. Ltd.
...
//#endregion
export { KPI as a, OPPORTUNITIES as c, SEGMENTS as d, SELLERS as f, INSIGHTS as i, PRODUCTS as l, CATEGORIES as n, MODELS as o, STATES as p, CITIES as r, MONTHLY_REVENUE as s, AI_SYSTEM_CONTEXT as t, REPORTS as u };
