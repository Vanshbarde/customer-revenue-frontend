...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DQs-i7lW.mjs");
...
var manifest = { "8c9c9a46815f0da2c7efa04a248a4d8443ad92b85dc45c10be00d93fb925ee8e": {
	functionName: "askBusinessAi_createServerFn_handler",
	importer: () => import("./ask-C6Jaz1-d.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-YTelVdr5.mjs").then((n) => n.t),
